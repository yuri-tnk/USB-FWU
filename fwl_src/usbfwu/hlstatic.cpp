// hlstatic.cpp : implementation file
//
...
BOOL CHyperLinkStatic::PreTranslateMessage(MSG* pMsg) 
{
...
/////////////////////////////////////////////////////////////////////////////
// CHyperLinkStatic operations

void CHyperLinkStatic::SetURL(CString strURL)
{
    m_strURL = strURL;
...
CString CHyperLinkStatic::GetURL() const
{ 
    return m_strURL;   
}

void CHyperLinkStatic::SetColours(COLORREF crLinkColour, COLORREF crVisitedColour,
...
COLORREF CHyperLinkStatic::GetLinkColour() const
{ 
    return m_crLinkColour; 
}

COLORREF CHyperLinkStatic::GetVisitedColour() const
{
    return m_crVisitedColour; 
}

COLORREF CHyperLinkStatic::GetHoverColour() const
{
    return m_crHoverColour;
}

void CHyperLinkStatic::SetVisited(BOOL bVisited /* = TRUE */) 
{ 
    m_bVisited = bVisited; 
...
BOOL CHyperLinkStatic::GetVisited() const
{ 
    return m_bVisited; 
}

void CHyperLinkStatic::SetLinkCursor(HCURSOR hCursor)
{ 
...
HCURSOR CHyperLinkStatic::GetLinkCursor() const
{
    return m_hLinkCursor;
}

void CHyperLinkStatic::SetUnderline(BOOL bUnderline /* = TRUE */)
{
...
BOOL CHyperLinkStatic::GetUnderline() const
{ 
    return m_bUnderline; 
}

void CHyperLinkStatic::SetAutoSize(BOOL bAutoSize /* = TRUE */)
{
...
BOOL CHyperLinkStatic::GetAutoSize() const
{ 
...
//
void CHyperLinkStatic::PositionWindow()
{
...
/////////////////////////////////////////////////////////////////////////////
// CHyperLinkStatic implementation

// The following appeared in Paul DiLascia's Jan 1998 MSJ articles.
// It loads a "hand" cursor from the winhlp32.exe module
void CHyperLinkStatic::SetDefaultCursor()
{
...
void CHyperLinkStatic::ReportError(int nError)
{
    CString str;
    switch (nError) 
    {
